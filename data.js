const pokedex = [
    ...
    { number: 12, name: 'Butterfree', type: 'bug', maxhp: 65,  hp: 65, maxxp: 15, xp: 0, starter: false, canEvolve: false, evolvesFrom: 'Metapod', rarity: 0, image: 'images/butterfree.png' },
    { number: 13, name: 'Weedle', type: 'bug', maxhp: 40,  hp: 40, maxxp: 5, xp: 0, starter: false, canEvolve: true, evolvesFrom: null, rarity: 1, image: 'images/weedle.png' },
    ...
    { number: 15, name: 'Beedrill', type: 'bug', maxhp: 65,  hp: 65, maxxp: 15, xp: 0, starter: false, canEvolve: false, evolvesFrom: 'Kakuna', rarity: 0, image: 'images/beedrill.png' },
    { number: 16, name: 'Pidgey', type: 'normal', maxhp: 40,  hp: 40, maxxp: 10, xp: 0, starter: false, canEvolve: true, evolvesFrom: null, rarity: 1, image: 'images/pidgey.png' },
    ...
    { number: 21, name: 'Spearow', type: 'normal', maxhp: 40,  hp: 40, maxxp: 10, xp: 0, starter: false, canEvolve: true, evolvesFrom: null, rarity: 7, image: 'images/spearow.png' },
    ...
    { number: 37, name: 'Vulpix', type: 'fire', maxhp: 40,  hp: 40, maxxp: 10, xp: 0, starter: false, canEvolve: true, evolvesFrom: null, rarity: 5, image: 'images/vulpix.png' },
    { number: 38, name: 'Ninetales', type: 'fire', maxhp: 80,  hp: 80, maxxp: 25, xp: 0, starter: false, canEvolve: false, evolvesFrom: 'Vulpix', rarity: 0, image: 'images/ninetales.png' },
    { number: 39, name: 'Jigglypuff', type: 'normal', maxhp: 40,  hp: 40, maxxp: 10, xp: 0, starter: false, canEvolve: true, evolvesFrom: null, rarity: 4, image: 'images/jigglypuff.png' },
    { number: 40, name: 'Wigglytuff', type: 'normal', maxhp: 80,  hp: 80, maxxp: 25, xp: 0, starter: false, canEvolve: false, evolvesFrom: 'Jigglypuff', rarity: 0, image: 'images/wigglytuff.png' },
    ...
    { number: 60, name: 'Poliwag', type: 'water', maxhp: 40,  hp: 40, maxxp: 10, xp: 0, starter: false, canEvolve: true, evolvesFrom: null, rarity: 6, image: 'images/poliwag.png' },
    ...
    { number: 64, name: 'Kadabra', type: 'psychic', maxhp: 40,  hp: 40, maxxp: 20, xp: 0, starter: false, canEvolve: true, evolvesFrom:  'Abra', rarity: 0, image: 'images/kadabra.png' },
    ...
    { number: 68, name: 'Machamp', type: 'fighting', maxhp: 90,  hp: 90, maxxp: 30, xp: 0, starter: false, canEvolve: false, evolvesFrom: 'Machoke', rarity: 0, image: 'images/machamp.png'},
    ...
    { number: 71, name: 'Victreebel', type: 'grass', maxhp: 80,  hp: 80, maxxp: 30, xp: 0, starter: false, canEvolve: false, evolvesFrom: 'Weepinbell', rarity: 0, image: 'images/victreebel.png' },
    ...
    { number: 76, name: 'Golem', type: 'rock', maxhp: 80,  hp: 80, maxxp: 30, xp: 0, starter: false, canEvolve: false, evolvesFrom: 'Graveler', rarity: 0, image: 'images/golem.png' },
    ...
    { number: 78, name: 'Rapidash', type: 'fire', maxhp: 75,  hp: 75, maxxp: 25, xp: 0, starter: false, canEvolve: false, evolvesFrom: 'Ponyta', rarity: 0, image: 'images/rapidash.png' },
    ...
    { number: 115, name: 'Kangaskhan', type: 'normal', maxhp: 100, hp: 100, maxxp: 50, xp: 0, starter: false, canEvolve: false, evolvesFrom: null, rarity: 6, image: 'images/kangaskhan.png' },
